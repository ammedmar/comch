...
class EilenbergZilber_element(Module_element):
    ...
    def __init__(self, data=None, dimension=None, torsion=None):
        """Initialize an instance of EilenbergZilber_element

        Create a new, empty EilenbergZilber_element object representing 0,
        and, if given, initialize a EilenbergZilber_element from a dict with
    ...
    def boundary(self):
        ...
        >>> x = EilenbergZilber_element({((0, 1), (1, 2)): 1})
        >>> print(x.boundary())
