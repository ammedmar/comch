...
class BarrattEcclesElement(FreeModuleElement):
    ...
    data : :class:`dict` or ``None``, default: ``None``
        ...
        in the dict correspond with pairs `basis_element: coefficient`. Each
        basis_element must create a :class:`tuple` of
        :class:`SymmetricGroupElement` and `coefficient` must be an
        :class:`int`.
    ...
    def complexity(self):
        ...
        finite binary sequence of elements in :math:`\Sigma_2` is defined
        as the number of consecutive distinct elements in it. For example,
        :math:`((12),(21),(21),(12))` and :math:`((12),(12),(12),(21))`
        have complexities 2 and 1 respectively. The complexity of a basis
        Barratt-Eccles element is defined as the maximum value of the
        complexities of its binary subsequences. Notice that for arity 2,
