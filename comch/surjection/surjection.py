...
class SurjectionElement(FreeModuleElement):
    ...
    def complexity(self):
        ...
        For elements in arity 2, the complexity agrees with the degree. For
        higher arity elements, it is the max of its arity 2 components. The
        suboperad contining all elements of complexity less than or equal to
        :math:`n` is an :math:`E_{n+1}`-operad.
    ...
    def suspension(self):
        ...
        Given a basis element u in arity :math:`r` and degree :math:`d` the
        suspension is in degree :math:`d-r+1` and is :math:`0` if
